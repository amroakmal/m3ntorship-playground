...
export const PostsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createOptionsGroup: async (postid: string, inlineObject: InlineObject, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'postid' is not null or undefined
            assertParamExists('createOptionsGroup', 'postid', postid)
            // verify required parameter 'inlineObject' is not null or undefined
            assertParamExists('createOptionsGroup', 'inlineObject', inlineObject)
...
export const PostsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createOptionsGroup(postid: string, inlineObject: InlineObject, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2011>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createOptionsGroup(postid, inlineObject, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const PostsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createOptionsGroup(postid: string, inlineObject: InlineObject, options?: any): AxiosPromise<InlineResponse2011> {
...
export class PostsApi extends BaseAPI {
     ...
     * @memberof PostsApi
     */
    public createOptionsGroup(postid: string, inlineObject: InlineObject, options?: any) {
        return PostsApiFp(this.configuration).createOptionsGroup(postid, inlineObject, options).then((request) => request(this.axios, this.basePath));
    }
